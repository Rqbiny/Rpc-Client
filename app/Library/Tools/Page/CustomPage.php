<?php
namespace App\Library\Tools\Page;
...
class CustomPage
{
    ...
    public static function getNowPage($nowPage, $count)
    {
        ...
        $totalPage = ceil($count / config('page')['page_num']);
    ...
    /**
     * 获取整个的分页样式
     * @param integer $nowPage 当前页
     * @param integer $totalPage 共多少页面
     * @param string $baseUrl  当前url(用url函数生成即可 url('demo'))
